...
function inline(msg)
	...
	tabless = '[{"text":"اکانت اصلی من","url":"https://telegram.me/'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/'..sudo_ch..'"}],[{"text":"کلبه رمان","url":"https://telegram.me/kolbeyeroman"},{"text":"سازنده ربات","url":"https://telegram.me/Webmagonline"}]'
